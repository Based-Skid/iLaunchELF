...
char *appVer = " v0.22 2020-06-03 (Commit: a8995bd)\n";
...
char *targets[]= {"2048.ELF", "ESDL.ELF", "ESR.ELF", "FCEU.ELF", "GBA.ELF", "GSM.ELF", "HDL.ELF", "NES.ELF", "OPL.ELF", "PICO.ELF", "SMS.ELF", "SNES.ELF", "WLE.ELF"};
char ELF_NO_EXT[] = "";
char PATH_ELF[] = "";
char PATH_APP[] = "";
char make_path[] = "";
