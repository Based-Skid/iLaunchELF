//Strings
extern char *appName = "VTSPS2-HBDL HomeBrew DownLoader";
extern char *appVer = " v0.33 2020-11-12 (Commit: b41e27d)\n";
extern char *appAuthor = "Forked from iLaunchElf by VTSTech github.com/Veritas83/VTSPS2-HBDL\nOriginal iLaunchElf By: krHACKen, Based_Skid, Copyright \xa9 2018 \n \n";
extern char *appNotice = "Notice: This App Contains Code from uLaunchELF \n";
...
extern char *devices[] = {"mc0:/", "mc1:/", "mass:/"};
extern char *paths[] = {"APPS/", "APP_$ELF/", "$ELF/", "BOOT/"};
extern char *actions[] = {"CHECK", "DOWNLOAD", "LAUNCH"};
extern char *targets[]= {"AURA.ELF", "DOSBOX.ELF", "EJECT.ELF", "ESR.ELF", "FRUITY.ELF", "GSM.ELF", "HDL.ELF", "HERMES.ELF", "INFOGB.ELF", "LBFN.ELF", "NEOCD.ELF", "OPL.ELF", "PGEN.ELF", "PS2DOOM.ELF", "PS2ESDL.ELF", "PS2SX.ELF", "PSMS.ELF", "PVCS.ELF", "RA_2048.ELF", "RA_FCEU.ELF", "RA_MGBA.ELF", "RA_PICO.ELF", "RA_QNES.ELF", "SMS.ELF", "SNES9X.ELF", "SNESSTN.ELF", "TESTMODE.ELF", "WLE.ELF", "XUMP.ELF", "ZONELDR.ELF"};
//char ELF_NO_EXT[] = "";
//char PATH_ELF[] = "";
//char PATH_APP[] = "";
extern char make_path[] = "";
extern char action[32], device[32], path[256], fn[16], ofn[16];
extern char url[] = "";
extern char mirror0[] = "http://hbdl.vts-tech.org/";
extern char mirror1[] = "http://www.hwc.nat.cu/ps2-vault/ps2hbdl/";
